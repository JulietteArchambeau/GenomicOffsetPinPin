...
# Environmental and pop structure data
...
data <- data %>% dplyr::select(prov,contains("ude_prov"),contains("WC"),contains("top_prov"),"depth_roots_prov")
colnames(data) <- c("prov",
                   str_sub(grep("ude_prov",colnames(data),value=TRUE),1,-6),
                   str_sub(grep("bio",colnames(data),value=TRUE),1,-8),
                   str_sub(grep("top_prov",colnames(data),value=TRUE),1,-6),
                   str_sub(grep("roots_prov",colnames(data),value=TRUE),1,-6))
data <- unique(data)
...
# We add the Burned areas:
data <- merge(data,readRDS(file="data/FireData/DfBurnedAreabyProv.rds"),by=c("prov","longitude","latitude"))
...
select.var.AvgSand <- c("bio1","bio2","bio12","bio14","sand_top","depth_roots","TRI","BurnedArea")
...
select.var.AvgWater <- c("bio1","bio2","bio12","bio14","water_top","depth_roots","TRI","BurnedArea")
...
select.var.ExtSand <- c("bio13","bio14","bio5","bio6","sand_top","depth_roots","TRI","BurnedArea")
...
select.var.ExtWater <- c("bio13","bio14","bio5","bio6","water_top","depth_roots","TRI","BurnedArea")
...
plot(gdm.AvgSand.splineDat[[1]][,"BurnedArea"], 
     gdm.AvgSand.splineDat[[2]][,"BurnedArea"], 
     type="l",
     lwd=3, 
     xlab="Burned areas", 
     ylab="Partial genetic distance",
...
```{r relImpCovariatesAvgSand}
# relative importance of the covariates
apply(gdm.AvgSand.splineDat$y,2,max)

# scaled relative importance of the covariates
maxImp <- max(gdm.AvgSand.splineDat$y)
RelVarImp <- gdm.AvgSand.splineDat$y / maxImp
apply(RelVarImp,2,max)
...
# saving for the following analyses (projecting and calculating the genomic offset)
saveRDS(gdm.AvgWater,file=paste0("outputs/GDM/models/GDMAvgWater_refSNPs.rds")) 
```
...
plot(gdm.AvgWater.splineDat[[1]][,"BurnedArea"], 
     gdm.AvgWater.splineDat[[2]][,"BurnedArea"], 
     type="l",
     lwd=3, 
     xlab="Burned areas", 
     ylab="Partial genetic distance",
...
```{r relImpCovariatesAvgWater}
# relative importance of the covariates
apply(gdm.AvgWater.splineDat$y,2,max)

# scaled relative importance of the covariates
maxImp <- max(gdm.AvgWater.splineDat$y)
RelVarImp <- gdm.AvgWater.splineDat$y / maxImp
apply(RelVarImp,2,max)

varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="AvgWater",SnpSet="Reference") %>% 
  bind_rows(varimpgdm)
```
...
plot(gdm.ExtSand.splineDat[[1]][,"BurnedArea"], 
     gdm.ExtSand.splineDat[[2]][,"BurnedArea"], 
     type="l",
     lwd=3, 
     xlab="Burned areas", 
     ylab="Partial genetic distance",
...
```{r relImpCovariatesExtSand}
# relative importance of the covariates
apply(gdm.ExtSand.splineDat$y,2,max)

# scaled relative importance of the covariates
maxImp <- max(gdm.ExtSand.splineDat$y)
RelVarImp <- gdm.ExtSand.splineDat$y / maxImp
apply(RelVarImp,2,max)

varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="ExtSand",SnpSet="Reference") %>% 
  bind_rows(varimpgdm)
```
...
plot(gdm.ExtWater.splineDat[[1]][,"BurnedArea"], 
     gdm.ExtWater.splineDat[[2]][,"BurnedArea"], 
     type="l",
     lwd=3, 
     xlab="Burned areas", 
     ylab="Partial genetic distance",
...
```{r relImpCovariatesExtWater}
# relative importance of the covariates
apply(gdm.ExtWater.splineDat$y,2,max)

# scaled relative importance of the covariates
maxImp <- max(gdm.ExtWater.splineDat$y)
RelVarImp <- gdm.ExtWater.splineDat$y / maxImp
apply(RelVarImp,2,max)

varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="ExtWater",SnpSet="Reference") %>% 
  bind_rows(varimpgdm)
```
...
```{r PlotCumulativeImptanceGFAvgSand,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
...
# Burned Areas
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="BurnedAreas",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
mtext(side=1, line=3.5, "Burned Areas", font=2,cex=0.8)
```
...
```{r PlotCumulativeImptanceGFAvgWater,cache=TRUE,fig.height=4,fig.width=4,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
```{r PlotCumulativeImptanceGFExtSand,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
```{r PlotCumulativeImptanceGFExtWater,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
# Fitting the models on the common candidate SNPs

Let's estimate the genetic-environment relationships for the reference SNPs.

## GDM analysis

```{r perfDFGDMComCand, echo=F}
perf <- data.frame(Set=c("AvgSand","AvgWater","ExtSand","ExtWater"),ExpDev=NA,CV9=NA,CV6=NA,CV2=NA)
```

### Set AvgSand

```{r RunGDMComCandAvgSand}
fstmat <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_CommonCandidates_AvgSand_scaled.rds")
...
# saving for the following analyses (projecting and calculating the genomic offset)
saveRDS(gdm.AvgSand,file=paste0("outputs/GDM/models/GDMAvgSand_CommonCandidates.rds")) 
```

Fitting the I-splines:

```{r IsplinesGDMAvgSandComCand,fig.height=9,fig.width=9,message=F}
gdm.AvgSand.pred <- predict.gdm(gdm.AvgSand, gdmTab)
...
```{r relImpCovariatesComCandAvgSand}
# relative importance of the covariates
apply(gdm.AvgSand.splineDat$y,2,max)
...
varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="AvgSand",SnpSet="CommonCandidates") %>% 
  bind_rows(varimpgdm)
```
...
```{r RunGDMComCandAvgWater}
fstmat <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_CommonCandidates_AvgWater_scaled.rds")
...
# saving for the following analyses (projecting and calculating the genomic offset)
saveRDS(gdm.AvgWater,file=paste0("outputs/GDM/models/GDMAvgWater_CommonCandidates.rds")) 
...
```{r IsplinesGDMAvgWaterComCand,fig.height=9,fig.width=9,message=F}
gdm.AvgWater.pred <- predict.gdm(gdm.AvgWater, gdmTab)
...
```{r relImpCovariatesComCandAvgWater}
# relative importance of the covariates
apply(gdm.AvgWater.splineDat$y,2,max)
...
varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="AvgWater",SnpSet="CommonCandidates") %>% 
  bind_rows(varimpgdm)
```
...
```{r FormatDataGDMExtSandComCand}
fstmat <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_CommonCandidates_ExtSand_scaled.rds")
fstmat <- as.data.frame(fstmat) 
fstmat <- fstmat %>%  tibble::rownames_to_column("prov")
...
# saving for the following analyses (projecting and calculating the genomic offset)
saveRDS(gdm.ExtSand,file=paste0("outputs/GDM/models/GDMExtSand_CommonCandidates.rds")) 
```

Fitting the I-splines:

```{r IsplinesGDMExtSandComCand,fig.height=9,fig.width=9,message=F}
# I-splines
layout(matrix(1:9,3,3))
gdm.ExtSand.splineDat <- isplineExtract(gdm.ExtSand)
...
```{r relImpCovariatesComCandExtSand}
# relative importance of the covariates
apply(gdm.ExtSand.splineDat$y,2,max)
...
varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="ExtSand",SnpSet="CommonCandidates") %>% 
  bind_rows(varimpgdm)
```
...
```{r FormatDataGDMExtWaterComCand}
fstmat <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_CommonCandidates_ExtWater_scaled.rds")
fstmat <- as.data.frame(fstmat) 
fstmat <- fstmat %>%  tibble::rownames_to_column("prov")
...
# saving for the following analyses (projecting and calculating the genomic offset)
saveRDS(gdm.ExtWater,file=paste0("outputs/GDM/models/GDMExtWater_CommonCandidates.rds")) 
```

Fitting the I-splines:

```{r IsplinesGDMExtWaterComCand,fig.height=9,fig.width=9,message=F}
# I-splines
layout(matrix(1:9,3,3))
gdm.ExtWater.splineDat <- isplineExtract(gdm.ExtWater)
...
```{r relImpCovariatesComCandExtWater}
# relative importance of the covariates
apply(gdm.ExtWater.splineDat$y,2,max)
...
varimpgdm <- data.frame(relimp=apply(RelVarImp,2,max)) %>% 
  rownames_to_column(var="covariate") %>% 
  mutate(CovSet="ExtWater",SnpSet="CommonCandidates") %>% 
  bind_rows(varimpgdm)
```
...
```{r SaveVarImpGDM}
saveRDS(varimpgdm,file="outputs/GDM/RelImpCovariate/varimpgdm.rds")
```
...
## GF analysis ### TO DOOOOOO


```{r LoadGenoPreparedComCand}
geno <- readRDS(file="data/PreparedDFforGDMandGF/GF/ProvAllelFrequenciesAllSNPs.rds")
```
...
```{r RmMinorAlleleFrequenciesComCand}
vec <- apply(geno[,-1],2,function(x) length(unique(x)))
vecsup <- vec[vec>5]
snps <- names(vecsup)
length(vecsup) # Number of SNPs polymorphic in > 5 populations
...
```{r RunGFmodelAvgSandComCand,eval=F}
gf <- gradientForest(cbind(envGF, SNPs), predictor.vars=colnames(envGF),
                        response.vars=colnames(SNPs), ntree=500, 
                        maxLevel=maxLevel, trace=T, corr.threshold=0.50)
saveRDS(gf,file=paste0("outputs/GF/models/GFAvgSand_refSNPs.rds")) 
...
```{r LoadModelAvgSandComCand,cache=TRUE}
gf <- readRDS(file=paste0("outputs/GF/models/GFAvgSand_refSNPs.rds"))
```


```{r PlotOverallImptanceGFAvgSandComCand, fig.height=4,fig.width=8,cache=TRUE}
plot(gf, plot.type="Overall.Importance")
mean(gf$result)
sd(gf$result)
```

```{r PlotCumulativeImptanceGFAvgSandComCand,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
```{r RunGFmodelAvgWaterComCand,eval=F}
gf <- gradientForest(cbind(envGF, SNPs), predictor.vars=colnames(envGF),
                        response.vars=colnames(SNPs), ntree=500, 
                        maxLevel=maxLevel, trace=T, corr.threshold=0.50)
saveRDS(gf,file=paste0("outputs/GF/models/GFAvgWater_refSNPs.rds")) 
...
```{r LoadModelAvgWaterComCand,cache=TRUE}
gf.mem <- readRDS(file=paste0("outputs/GF/models/GFAvgWater_refSNPs.rds"))
```


```{r PlotOverallImptanceGFAvgWaterComCand,cache=TRUE, fig.height=4,fig.width=8}
plot(gf.mem, plot.type="Overall.Importance")
mean(gf.mem$result)
sd(gf.mem$result)
```

```{r PlotCumulativeImptanceGFAvgWaterComCand,cache=TRUE,fig.height=4,fig.width=4,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
```{r RunGFmodelExtSandComCand,eval=F}
gf <- gradientForest(cbind(envGF, SNPs), predictor.vars=colnames(envGF),
                        response.vars=colnames(SNPs), ntree=500, 
                        maxLevel=maxLevel, trace=T, corr.threshold=0.50)
saveRDS(gf,file=paste0("outputs/GF/models/GFExtSand_refSNPs.rds")) 
...
```{r LoadModelExtSandComCand,cache=TRUE}
gf <- readRDS(file=paste0("outputs/GF/models/GFExtSand_refSNPs.rds"))
```


```{r PlotOverallImptanceGFExtSandComCand, fig.height=4,fig.width=8,cache=TRUE}
plot(gf, plot.type="Overall.Importance")
mean(gf$result)
sd(gf$result)
```

```{r PlotCumulativeImptanceGFExtSandComCand,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
...
```{r RunGFmodelExtWaterComCand,eval=F}
gf <- gradientForest(cbind(envGF, SNPs), predictor.vars=colnames(envGF),
                        response.vars=colnames(SNPs), ntree=500, 
                        maxLevel=maxLevel, trace=T, corr.threshold=0.50)
saveRDS(gf,file=paste0("outputs/GF/models/GFExtWater_refSNPs.rds")) 
...
```{r LoadModelExtWaterComCand,cache=TRUE}
gf <- readRDS(file=paste0("outputs/GF/models/GFExtWater_refSNPs.rds"))
```


```{r PlotOverallImptanceGFExtWaterComCand, fig.height=4,fig.width=8,cache=TRUE}
plot(gf, plot.type="Overall.Importance")
mean(gf$result)
sd(gf$result)
```

```{r PlotCumulativeImptanceGFExtWaterComCand,fig.height=4,fig.width=4,cache=TRUE,fig.show="hold", out.width="33%"}
# MEM 1
plot(gf, plot.type="Cumulative.Importance",
     imp.vars="MEM1",
     plot.args=list(show.species=FALSE,show.overall=TRUE))
