...
graphs <- lapply(c("betaGO_country[1]","betaGO_country[2]"), function(x){
  ...
  scale_colour_manual(values=c("forestgreen","chartreuse2","gold1"),labels=c("Common SNP candidates",
            "Merged SNP candidates",
            "Reference SNPs"),name="SNP sets") +
  scale_shape_manual(values=c(16,17,8),labels=c("Common SNP candidates",
            "Merged SNP candidates",
            "Reference SNPs"),name="SNP sets") +
