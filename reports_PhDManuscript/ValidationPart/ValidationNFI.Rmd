...
ggsave(grid.graphs, file="figs/manuscript/ValidationNFI.pdf",device="pdf",height=8,width=10)
ggsave(grid.graphs, file="figs/manuscript/ValidationNFI.png",height=8,width=10)
grid.graphs 
```
