...
# We save this dataset for the DRYAD repository
data.cg %>% write_csv("data_DRYAD/EnvDataCommonGarden.csv", append=FALSE)

# We format the dataframe for the gdm analysis:
