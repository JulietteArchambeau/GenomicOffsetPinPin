...
data %>% dplyr::select(-metap, -region ,-clon_original, -clones522, -block_original, -bb, -dbb, -d13C, -SLA) %>% 
  write_csv("data_DRYAD/PhenoEnvPopStructureDataset.csv", append=FALSE)
```
