...
plot(gdm.9.splineDat[[1]][,"bio13"], 
     gdm.9.splineDat[[2]][,"bio13"], 
     type="l",
     lwd=3, 
...
plot(gdm.9.splineDat[[1]][,"bio14"], 
     gdm.9.splineDat[[2]][,"bio14"], 
     type="l",
     lwd=3, 
...
plot(gdm.9.splineDat[[1]][,"bio5"], 
     gdm.9.splineDat[[2]][,"bio5"], 
     type="l",
     lwd=3, 
...
plot(gdm.9.splineDat[[1]][,"bio6"], 
     gdm.9.splineDat[[2]][,"bio6"], 
     type="l",
     lwd=3, 
     xlab="Min T° of the driest month (°C)", 
     ylab="Partial Ecological Distance",
     ylim=c(0,0.2))

plot(gdm.9.splineDat[[1]][,"sand_top"], 
     gdm.9.splineDat[[2]][,"sand_top"], 
     type="l",
     lwd=3, 
     xlab="Sand top (%)", 
     ylab="Partial Ecological Distance",
...
plot(gdm.9.splineDat[[1]][,"depth_roots"], 
     gdm.9.splineDat[[2]][,"depth_roots"], 
     type="l",
     lwd=3, 
     xlab="Depth roots (cm)", 
     ylab="Partial Ecological Distance",
...
```{r PlotGOSet5BeforeSelectionFutClimAllGCMsSSP370,fig.height=8,fig.width=10}
rast.go <- stackall[[1]]
...
```{r PlotFuturePredictionsAllGCMsSSP370, fig.height=6,fig.width=8}
