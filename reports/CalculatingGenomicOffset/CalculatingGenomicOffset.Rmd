...
pdf(paste0("outputs/GDM/Projections/",time,"ProjPCA_Res",res,"_",scenario,"_",snp.sets.codes[[counter]],"_GDM.pdf"))
...
pdf(paste0("outputs/GDM/GenomicOffset/MapGenomicOffset_",x,"_",snp.sets.codes[[counter]],"_GDM.pdf"))
...
pdf(paste0("outputs/GF/Projections/",time,"ProjPCA_Res",res,"_",scenario,"_",snp.sets.codes[[counter]],"_GF.pdf"))
plot((pca$x[, 1:2]), 
     xlim = xrng, 
     ylim = yrng, 
     pch = ".", 
...
pdf(paste0("outputs/GF/GenomicOffset/MapGenomicOffset_",scenario,"_",snp.sets.codes[[counter]],"_GF.pdf"))
plot(background,col=grayscale_colors, 
     axes=FALSE,
