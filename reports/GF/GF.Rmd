...
genOffBS <- sqrt((projCur[,1]-predFut[,1])^2+(projCur[,2]-predFut[,2])^2
...
# calculate euclidean distance between current and future genetic spaces  
genOffAScacmad <- sqrt((projCur[,1]-predFut[,1])^2+(projCur[,2]-predFut[,2])^2
                    +(projCur[,3]-predFut[,3])^2+(projCur[,4]-predFut[,4])^2
                    +(projCur[,5]-predFut[,5])^2+(projCur[,6]-predFut[,6])^2)
...
# calculate euclidean distance between current and future genetic spaces  
genOffAScac <- sqrt((projCur[,1]-predFut[,1])^2+(projCur[,2]-predFut[,2])^2
                    +(projCur[,3]-predFut[,3])^2+(projCur[,4]-predFut[,4])^2
                    +(projCur[,5]-predFut[,5])^2+(projCur[,6]-predFut[,6])^2)
...
```{r ComparingBeforeAndAfterSelectionSet5CacOnly,fig.width=12}
