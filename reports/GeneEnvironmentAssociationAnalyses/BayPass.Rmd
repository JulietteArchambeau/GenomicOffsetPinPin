...
```{r CalculateAlleleCounts, eval=T}
...
~/Bureau/baypass_2.2/sources/g_baypass \
    -gfile ../9833snps457clones_ImpNABayPass \
    -outprefix anacore1 \
    -seed 44
```
...
```{bash ISrunsWaterTop, eval=T}
cd ~/Documents/GenomicOffset/GenomicOffsetPinPin/outputs/CandidateSNPs/baypass/ISruns_WaterTop
...
```{bash ISrunsDepthRoots, eval=T}
cd ~/Documents/GenomicOffset/GenomicOffsetPinPin/outputs/CandidateSNPs/baypass/ISruns_DepthRoots
