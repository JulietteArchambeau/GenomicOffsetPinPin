...
# saveRDS(fst,file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_withNeg.rds")
fst <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_withNeg.rds")
```
...
round(fst,2)
fst
# saveRDS(fst,file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix5165Snps34Provs_noNeg.rds")
```
...
```{r ComputeFstMatrixCandidateSNPs}
#fst <- pairwise.WCfst(geno,diploid=TRUE)
#saveRDS(fst,file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix183CandSnps_withNeg.rds")
fst <- readRDS(file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix183CandSnps_withNeg.rds")
fst[1:10,1:10]
```
...
```{r NegValuestoZeroFstMatrixCandidateSNPs}
fst[which(fst <0)]
fst[which(fst <0)] <- 0
round(fst,2)
fst
#saveRDS(fst,file="data/PreparedDFforGDMandGF/GDM/FstMatrices/FstMatrix183CandSnps_noNeg.rds")
```


```{r visualizeMatrixFstCandidateSNPs, fig.height=20,fig.width=20}
source("scripts/Functions/corpmat.R")
col <- colorRampPalette(c("#BB4444", "#EE9988", "#FFFFFF", "#77AADD", "#4477AA"))
